...
with tf.Session() as sess:
    ...
    if isWeight:
        ...
        ims("results/" + "celeba_generation" + str(0) + ".png", merge2(myTT, [4, 4]))

        ims("results/" + "celeba_generation" + str(0) + ".png", merge2(ypp, [8, 8]))
        ims("results/" + "celeba_test" + str(0) + ".png", merge2(x_fixed, [8, 8]))

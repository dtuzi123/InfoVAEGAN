...
def myReconstruction(x_hat, z_in, y_in):
    code_real, code_logit_real, mean_real, std_real = encoder(x_hat, discrete_len, continous_len,reuse=True)
    ...
    G_real = generator2(discrete_real, continous, reuse=True)
    return G_real
...
myReconstructed2 = myReconstruction(x_hat, z_in, y_in)
...
with tf.Session() as sess:
    ...
    if isWeight:
        saver.restore(sess, 'models/InfoVAE_Celeba_AdditionalGenerator2')

        # Train a generator from the trained InfoVAE
        ...
        y_2 = sess.run(myReconstructed2,feed_dict={z_in: batch_z, x_hat: x_fixed, y_in: batch_codes})
        ...
        ims("results/" + "InfoVAE_" + str(0) + ".png", merge2(my111, [3, 10]))
        ...
        for epoch in range(n_epochs):
            ...
            saver.save(sess, "models/InfoVAE_Celeba_AdditionalGenerator2")

...
DATA_PATH = 'C:/commonData/stl10/train_X.bin'
DATA_PATH2 = 'C:/commonData/stl10/unlabeled_X.bin'

LABEL_PATH = 'C:/commonData/stl10/train_y.bin'
...
with tf.Session() as sess:
    ...
    if isWeight:
        saver.restore(sess, 'F:/Third_Experiment/models/InfoVAE_STL10')

...
with tf.Session() as sess:
    ...
    if isWeight:
        ...
        reco,dropoutA,dropout_Samples, = sess.run((y,dropoutA,dropoutSamples),feed_dict={x_hat: x_fixed, x: x_fixed, keep_prob: 1.0})
    ...
    for epoch in range(n_epochs):
        ...
        for i in range(total_batch):
            ...
            _, tot_loss, loss_likelihood, loss_divergence,dropout_a = sess.run(
                (train_op, loss, neg_marginal_likelihood, KL_divergence,dropoutA),
